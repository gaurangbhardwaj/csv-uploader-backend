...
export const stringConstants = {
  SERVICE_STATUS_HTML:
    ...
    "csv-upload micro-service is working fine</div></body>",
};
...
export const apiSuccessMessage = {
  ...
  COUNTRIES_ADDED: "Countries has been added successfully",
  GET_COUNTRIES: "Countries has been fetched successfully",
  GET_FILTERS: "Filters has been fetched successfully",
  REMOVE_COUNTRIES: "Countries has been removed successfully"
};
...
export const apiFailureMessage = {
  ...
  COUNTRIES_ADDED: "Unable to add countries",
  GET_COUNTRIES: "Unable to get countries",
  GET_FILTERS: "Unable to get filters",
  REMOVE_COUNTRIES: "Unable to remove countries"
};
